    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 z-50 w-full max-w-sm transform overflow-hidden rounded-xl bg-white shadow-2xl transition-all border border-gray-200"
        >
              {/* Header avec gradient */}
              <div className="bg-gradient-to-r from-violet-electric via-purple-600 to-indigo-600 px-4 py-3">
              ...
              <div className="px-4 py-4 max-h-[60vh] overflow-y-auto">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <h3 className="text-sm font-semibold text-gray-900">Nécessaires</h3>
                        <span className="text-xs font-medium text-violet-electric bg-violet-50 px-1.5 py-0.5 rounded">
                          Actif
                        </span>
                      </div>
                    ...
                    <div className="flex items-center flex-shrink-0">
                      <input
                        ...
                        disabled
                        className="w-4 h-4 text-violet-electric border-gray-300 rounded focus:ring-violet-electric cursor-not-allowed opacity-50"
                      />
                    </div>
                  </div>

                  {/* Cookies analytiques */}
                  <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-violet-300 transition-colors">
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm font-semibold text-gray-900 mb-1">Analytiques</h3>
                      <p className="text-xs text-gray-600">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-violet-300 transition-colors">
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm font-semibold text-gray-900 mb-1">Marketing</h3>
                      <p className="text-xs text-gray-600">
                ...
                <div className="flex flex-col gap-2">
                  <button
                    ...
                    className="w-full px-3 py-2 text-xs font-medium text-white bg-gradient-to-r from-violet-electric to-purple-600 rounded-lg hover:from-violet-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg"
                  >
                    Tout accepter
                  </button>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 px-3 py-2 text-xs font-medium text-white bg-violet-electric rounded-lg hover:bg-violet-700 transition-colors"
                    >
                      Personnaliser
                    </button>
                  </div>
