...
| **Paiements** | Stripe | DSP2/SCA natif, Conformité PCI DSS Level 1 |
...
4. **Conformité Paiements**
   ...
   - ✅ 3D Secure 2.0 automatique (DSP2)
...
1. **Sécurité** ✅
   - [x] Stack conforme PCI DSS ? → Oui (Stripe)
   - [x] DSP2/SCA géré ? → Oui (Stripe automatique)
